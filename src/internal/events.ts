...
type NativeRewardedErrorAdEventType =
  | NativeInterstitialErrorAdEventType
  | 'reward_failed';
...
interface PangleInterstitialNativeLifecycleEvent
  extends PangleMediationNativeBaseAdEvent {
  adType: 'interstitial';
  ecpm?: undefined;
  error?: undefined;
  reward?: undefined;
...
interface PangleInterstitialNativeEcpmEvent
  extends PangleMediationNativeBaseAdEvent {
  adType: 'interstitial';
...
interface PangleInterstitialNativeErrorEvent
  extends PangleMediationNativeBaseAdEvent {
  adType: 'interstitial';
  ecpm?: undefined;
...
interface PangleRewardedNativeLifecycleEvent
  extends PangleMediationNativeBaseAdEvent {
  adType: 'rewarded';
  ecpm?: undefined;
  error?: undefined;
...
interface PangleRewardedNativeEcpmEvent
  extends PangleMediationNativeBaseAdEvent {
  adType: 'rewarded';
  ecpm?: PangleAdEcpmInfo;
  error?: undefined;
...
export type PangleMediationNativeAdEvent =
  | PangleInterstitialNativeLifecycleEvent
  | PangleInterstitialNativeEcpmEvent
  | PangleInterstitialNativeErrorEvent
  | PangleRewardedNativeLifecycleEvent
  | PangleRewardedNativeEcpmEvent
  | PangleRewardedNativeErrorEvent
  | PangleRewardEarnedNativeEvent;
 ...
 */
export function extractEventPayload(event: PangleMediationNativeAdEvent) {
  if (event.error != null) {
    return event.error;
  }
