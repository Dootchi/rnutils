...
export declare enum PangleRewardedAdEventType {
    REWARD_FAILED = "reward_failed",
    REWARD_EARNED = "reward_earned"
}
export type PangleMediationAdEventType = `${PangleAdEventType}` | `${PangleRewardedAdEventType}`;
...
export type PangleAdEventMap = PangleInterstitialEventMap | PangleRewardedEventMap;
export type PangleAdEventListener<TEventMap, K extends keyof TEventMap> = (payload: TEventMap[K]) => void;
